###############################################################################
# ComputeGlobalMeanThermalExpansion.py: From CMIP5 (and CMIP6?) data
...
DIR_IPCC = '/nobackup/users/bars/SeaLevelFromHylke/CMIP5_OCEAN/AR5calculations_Jonathan/project/'
